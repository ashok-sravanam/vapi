...
const VoiceAssistant: React.FC = () => {
  ...
  const [connectionStatus, setConnectionStatus] = useState<'connecting' | 'connected' | 'active' | 'disconnected'>('connecting');
      ...
      <div className="relative z-10 p-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          <div className={`px-3 py-1 rounded-full text-sm font-medium ${
            connectionStatus === 'active' ? 'bg-green-500/20 text-green-400' :
            connectionStatus === 'connected' ? 'bg-blue-500/20 text-blue-400' :
            connectionStatus === 'connecting' ? 'bg-yellow-500/20 text-yellow-400' :
            'bg-red-500/20 text-red-400'
          }`}>
            {connectionStatus === 'active' ? '● AI Coach Active' :
             connectionStatus === 'connected' ? '● AI Coach Ready' :
        ...
        >
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 p-8 max-w-4xl mx-auto">
            ...
            <div className="mb-8">
              ...
              {!vapiLoading && connectionStatus === 'connected' && !isVapiCallActive && (
              ...
              {!vapiLoading && connectionStatus === 'active' && (
                <div className="space-y-2">
                  <div className="text-green-400 font-medium flex items-center justify-center">
                    ...
                    {isSpeaking ? 'AI Coach is speaking...' : 'AI Coach is listening...'}
                  </div>
                  <div className="text-gray-300 text-lg">
                    🎤 Speak naturally - ask questions, get feedback, or request exercises
                  </div>
                </div>
              )}
            ...
            <div className="flex items-center justify-center space-x-6">
              {!isVapiCallActive && !vapiLoading && connectionStatus === 'connected' && (
                <motion.button
          ...
          {!isVapiCallActive && (
            ...
            >
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Natural Conversation</h3>
                <p className="text-gray-400 text-sm">
                  Speak naturally with your AI coach. Ask questions, get feedback, and receive personalized guidance.
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
                ...
                <p className="text-gray-400 text-sm">
                  Get instant vocal coaching advice and technique corrections during your conversation.
                </p>
              </div>
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50">
                ...
                <h3 className="text-lg font-semibold text-white mb-2">Personalized Coaching</h3>
                <p className="text-gray-400 text-sm">
                  Receive coaching tailored to your voice type, skill level, and specific goals.
                </p>
              </div>
            </motion.div>
          )}
