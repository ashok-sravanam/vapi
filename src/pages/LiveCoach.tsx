...
const LiveCoach: React.FC = () => {
  ...
  useEffect(() => {
    if (recordingComplete && audioBlob && user && sessionActive && sessionState.phase === 'recording') {
  ...
  }, [recordingComplete, audioBlob, user, sessionActive, sessionState.phase, analyzeVoice, addDebugInfo]);
